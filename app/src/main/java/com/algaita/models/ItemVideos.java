...
public class ItemVideos {
    ...
    public ItemVideos(String id, String CategoryId, String CategoryName, String artist, String Mp3Url,String imageBig, String imageSmall, String Mp3Name, String Duration, String Description, String totalRate, String averageRating, String views, String downloads) {
        this.id = id;
